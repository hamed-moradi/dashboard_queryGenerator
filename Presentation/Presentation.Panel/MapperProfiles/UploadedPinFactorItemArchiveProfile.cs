...
{
    public class UploadedPinFactorItemArchiveProfile:Profile
    {
        public UploadedPinFactorItemArchiveProfile()
        {
            PersianDateTime persianDt;
            CreateMap<UploadedPinFactorItemArchiveViewModel, UploadedPinFactorItemArchive>()
            ...
            CreateMap<UploadedPinFactorItemArchive, UploadedPinFactorItemArchiveViewModel>()
