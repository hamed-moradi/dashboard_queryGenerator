...
{
    public class VehicleTrimProfile : Profile
    {
        public VehicleTrimProfile()
        {
            PersianDateTime tester;
            CreateMap<VehicleTrimViewModel, VehicleTrim>()
            ...
            CreateMap<VehicleTrim, VehicleTrimViewModel>()
                ...
                .ForMember(d => d.DateTypeId, s => s.MapFrom(mf => mf.DateTypeId.HasValue ? (GeneralEnums.DateType)mf.DateTypeId : (GeneralEnums.DateType?)null))
